...
namespace Flight_Document_V1.Migrations
{
    ...
    [Migration("20231214033941_AddDataDocumentType")]
    partial class AddDataDocumentType
    {
            ...
            modelBuilder.Entity("Flight_Document_V1.Entity.Group", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            GroupID = 1,
                            CreateDateGroup = new DateTime(2023, 12, 14, 10, 39, 41, 634, DateTimeKind.Local).AddTicks(4514),
                            Creator = "DEV",
